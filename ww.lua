...
local function SendWebhook(data, category)
    ...
    if category == "STARTUP" then
        embedTitle = "🚀 WEBHOOK ACTIVED"
        embedColor = 5763719
        descriptionText = "ITG Webhook is now active on **" .. Players.LocalPlayer.Name .. "**'s.\nlinktr.ee/itgdisini"
    elseif category == "DISCONNECT" then
        embedTitle = "WEBHOOK DISCONNECTED"
        embedColor = 16711680
    ...
    local embedData = { 
        ["username"] = "ITG", 
        ["avatar_url"] = "https://i.imgur.com/v9MY7kV.png", 
        ["content"] = contentMsg, 
        ["embeds"] = {{ 
            ["title"] = embedTitle, 
            ["description"] = descriptionText, 
            ["color"] = embedColor, 
            ["footer"] = { ["text"] = "ITG | linktr.ee/itgdisini", ["icon_url"] = "https://i.imgur.com/v9MY7kV.png" } 
        }} 
    }
